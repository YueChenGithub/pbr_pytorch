...
def save_compared_result(name, scene):
    metadata_path = f"./scenes/cube_rough/{name}/metadata.json"
    """read information"""
    ...
    """load bl image"""
    normal_bl_path = f"./scenes/cube_rough/{name}/Normal_0001.png"
    rgb_gt_path = f"./scenes/cube_rough/{name}/GlossIndCol_0001.png"
    ...
    output_root = "./tests/compare_mi_blender/cube"
